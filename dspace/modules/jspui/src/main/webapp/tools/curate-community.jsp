...
%>
		...
		<input type="hidden" name="community_id" value="<%= communityID %>"/>
          ...
          <!--Commented because queue is forbidden <input class="btn btn-warning col-md-6" type="submit" name="submit_community_queue" value="<fmt:message key="jsp.tools.curate.queue.button"/>" />-->
