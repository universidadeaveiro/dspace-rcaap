	...
	%>
		...
		%>
			...
			<!--RCAAP - FCCN - LINKS instead of of Button --> 
		      	<h4><a style="text-decoration-color: #000; color: #000;" href="<%= request.getContextPath() %>/handle/<%=item.getHandle() %>" class="text-muted">
			
			<!--<h4><%= StringUtils.abbreviate(displayTitle, 400) %></h4></a>-->
